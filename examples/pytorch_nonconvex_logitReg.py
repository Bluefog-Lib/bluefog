...
if args.method == 'exact_diffusion':
    w, mse = exact_diffusion(w_opt, rho, beta, maxite=args.max_iter)
elif args.method == 'gradient_tracking':
    w, mse = gradient_tracking(w_opt, rho, beta, maxite=args.max_iter)
elif args.method == 'push_diging':
    w, mse = push_diging(w_opt, rho, beta, maxite=args.max_iter)
else:
